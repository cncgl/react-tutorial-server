# -*- encoding: utf-8 -*-
# stub: active_model_serializers 0.10.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<railties>, ["< 6", ">= 4.1"])
      s.add_runtime_dependency(%q<jsonapi>, ["~> 0.1.1.beta2"])
      ...
      s.add_dependency(%q<jsonapi>, ["~> 0.1.1.beta2"])
